import { IFilePathInfo } from './IFilePathInfo';
import { HashAlgorithm } from './FileSystemTypes';
...
declare module 'react-native' {
    namespace NativeModules {
        interface IRNFSManager {
             ...
             */
            writeFile(filepath: string, base64Content: string): Promise<null | {
                filePath: string;
                exception: Error;
            }>;
            /**
             ...
             */
            downloadFile(options: IDownloadOptions): Promise<IDownloadResult>;
            /**
