...
export interface IFileSystemiOS extends IFileSystem {
     ...
     */
    uploadFiles(options: IUploadOptions, downloadBeginCbFn?: (result: IUploadBegin) => void, downloadProgressCbFn?: (result: IUploadProgress) => void): IJobTicket<IUploadResult>;
}
