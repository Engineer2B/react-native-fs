...
declare module "react-native" {
	namespace NativeModules {
		...
		export interface IAndroidRNFSManager extends IRNFSManager {
			 ...
			 */
			readDirAssets(directory: string): Promise<native.FilePathInfo[]>;
			 ...
			 */
			getFSInfo(filePath?: string): Promise<native.FileSystemInfo>;
		}
	}
}